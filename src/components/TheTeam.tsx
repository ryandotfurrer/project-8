...
<div className="flex justify-around items-center">
  <div className="flex flex-col items-center text-center">
    <a href="/person1" className="flex flex-col items-center">
  ...
  <div className="flex flex-col items-center text-center">
    <a href="/person2" className="flex flex-col items-center">
  ...
  <div className="flex flex-col items-center text-center">
    <a href="/person3" className="flex flex-col items-center">
