  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 transition-colors">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-8">Meet The Team</h1>     
        <div className="grid grid-cols-2 gap-8">
          <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-500 mb-4">VP of Global Community</p>
            <p className="text-gray-600 mb-4">Taylor is passionate about building communities and connecting people across the globe.</p>
          ...
          <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-500 mb-4">Community Evangelist</p>
            <p className="text-gray-600 mb-4">Jason loves engaging with community members and sharing valuable insights.</p>
            <div className="flex space-x-4">
          ...
          <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-500 mb-4">Community Evangelist</p>
            <p className="text-gray-600 mb-4">Ximena is dedicated to fostering a welcoming and inclusive community environment.</p>
            <div className="flex space-x-4">
          ...
          <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-500 mb-4">Head of Global Community Operations</p>
            <p className="text-gray-600 mb-4">Briana is a dedicated community builder and experience creator, passionate about fostering meaningful connections and curating memorable events that inspire and uplift.</p>
            <div className="flex space-x-4">
          ...
          <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-500 mb-4">Platform Evangelist</p>
            <p className="text-gray-600 mb-4">As a platform evangelist, Lucca builds vibrant engineering communities and champions emerging technologies that push boundaries.</p>
            <div className="flex space-x-4">
          ...
          <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-500 mb-4">Platform Evangelist</p>
            <p className="text-gray-600 mb-4">Luana is passionate about connecting people with opportunities and fostering an environment where everyone feels welcome and valued.</p>
            <div className="flex space-x-4">
